...
const BoschMetadataProcessor = function (_cfg) {
    ...
    displaycfg.trajectories = displaycfg.trajectories || true;
    ...
    var _ct_accumulated_data = [];
    var _ct_running_total = 0;

    function processMsg(msg) {
        _ct_running_total = _ct_running_total + 1
        _ct_accumulated_data.push(msg)
        // console.log(JSON.stringify(msg))
        if (_ct_running_total % 500 == 0)
        {
            const blob = new Blob([JSON.stringify(_ct_accumulated_data)], { type: 'text/plain' });
